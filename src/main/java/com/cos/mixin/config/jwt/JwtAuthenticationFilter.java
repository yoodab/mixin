...
import com.cos.mixin.dto.user.UserReqDto.LoginReqDto;
import com.cos.mixin.dto.user.UserRespDto.LoginRespDto;
import com.cos.mixin.until.CustomResponseUtil;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(
                    loginReqDto.getUserEmail(), loginReqDto.getUserPassword());
