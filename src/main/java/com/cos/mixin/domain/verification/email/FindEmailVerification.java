...
@Getter
@Entity
public class FindEmailVerification {
	@Id
    ...
    @Builder
	public FindEmailVerification(String userEmail, String code, LocalDateTime requestTime, int requestCount) {
    ...
    @Builder
	public FindEmailVerification(EmailReqDto emailReqDto) {
